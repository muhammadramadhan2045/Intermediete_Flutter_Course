...
import 'package:latihan_image_picker/data/model/upload_response.dart';
...
class UploadProvider extends ChangeNotifier {
  ...
  Future<void> uploadImage(
    ...
    try {
      ...
      uploadResponse =
          await apisService.uploadDocument(bytes, fileName, description);
      message = uploadResponse?.message ?? "sukses";
      isUploading = false;
      notifyListeners();
    } catch (e) {
      message = e.toString();
